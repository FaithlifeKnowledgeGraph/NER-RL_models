# From: https://github.com/princeton-nlp/PURE/blob/main/entity/models.py
...
class BertForEntity(BertPreTrainedModel):
    ...
    def _get_span_embeddings(self,
        ...
        # Concatentate embeddings of left/right points and the width embedding
...
class EntityModel():
    ...
    def _get_input_tensors(self, tokens, spans, spans_ner_label):
        ...
        bert_spans = [
            [start2idx[span[0]], end2idx[span[1]], span[2]] for span in spans
        ]
