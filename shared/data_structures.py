...
class Span:
    ...
    def __eq__(self, other):
        return (self.span_doc == other.span_doc and
                self.span_sent == other.span_sent and self.text == other.text)
...
class Argument:
    ...
    def __eq__(self, other):
        return (self.span == other.span and self.role == other.role and
...
class NER:
    ...
    def __eq__(self, other):
        return (self.span == other.span and self.label == other.label and
...
class Events:
    ...
    def matches_except_event_type(self, argument):
        matched = [
            candidate for candidate in self.span_matches(argument)
            if candidate.event_type != argument.event_type and
            candidate.role == argument.role
        ]
        return set(matched)
